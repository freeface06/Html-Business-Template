...
<title>Pricing - Digital Support</title>
					...
					<div class="col-md-5 col-lg-4">
						<div class="clean-pricing-item">
							...
							<div class="features">
								...
								<h4>
									<span class="feature">Duration:&nbsp;</span><span>30
										Days</span>
								</h4>
								<h4>
					...
					<div class="col-md-5 col-lg-4">
						<div class="clean-pricing-item">
							...
							<div class="features">
								...
								<h4>
									<span class="feature">Duration:&nbsp;</span><span>60
										Days</span>
								</h4>
								<h4>
					...
					<div class="col-md-5 col-lg-4">
						<div class="clean-pricing-item">
							...
							<div class="features">
								...
								<h4>
									<span class="feature">Duration:&nbsp;</span><span>120
										Days</span>
								</h4>
								<h4>
